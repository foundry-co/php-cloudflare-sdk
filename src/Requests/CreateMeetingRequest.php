 ...
 * Create a meeting
 */
readonly class CreateMeetingRequest
{
	public function __construct(
		/** The AI Config allows you to customize the behavior of meeting transcriptions and summaries */
		public ?\FoundryCo\Cloudflare\Responses\CreateMeetingRequestAiConfig $aiConfig = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Responses\CreateMeetingRequestRecordingConfig $recordingConfig = null,
