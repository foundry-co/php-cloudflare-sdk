 ...
 * Patch Pools
 */
readonly class AccountLoadBalancerPoolsPatchPoolsRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AccountLoadBalancerPoolsPatchPoolsRequestNotificationEmail $notificationEmail = null,
	) {
	}
