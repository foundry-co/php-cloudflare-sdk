 ...
 * Update Monitor
 */
readonly class AccountLoadBalancerMonitorsUpdateMonitorRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AccountLoadBalancerMonitorsUpdateMonitorRequestType $type = null,
	) {
	}
