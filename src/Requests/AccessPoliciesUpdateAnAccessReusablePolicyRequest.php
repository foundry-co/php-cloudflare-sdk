 ...
 */
readonly class AccessPoliciesUpdateAnAccessReusablePolicyRequest
{
	public function __construct(
		/** The action Access will take if a user matches this policy. Infrastructure application policies can only use the Allow action. */
		public \FoundryCo\Cloudflare\Enums\AccessPoliciesUpdateAnAccessReusablePolicyRequestDecision $decision,
		...
		public ?\FoundryCo\Cloudflare\Responses\AccessPoliciesUpdateAnAccessReusablePolicyRequestConnectionRules $connectionRules = null,
		/** Require this application to be served in an isolated browser for users matching this policy. 'Client Web Isolation' must be on for the account in order to use this feature. */
		public ?bool $isolationRequired = null,
		/** Configures multi-factor authentication (MFA) settings. */
		public ?\FoundryCo\Cloudflare\Responses\AccessPoliciesUpdateAnAccessReusablePolicyRequestMfaConfig $mfaConfig = null,
