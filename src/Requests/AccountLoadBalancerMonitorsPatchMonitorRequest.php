 ...
 * Patch Monitor
 */
readonly class AccountLoadBalancerMonitorsPatchMonitorRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AccountLoadBalancerMonitorsPatchMonitorRequestType $type = null,
	) {
	}
