 ...
 * Create Monitor
 */
readonly class AccountLoadBalancerMonitorsCreateMonitorRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AccountLoadBalancerMonitorsCreateMonitorRequestType $type = null,
	) {
	}
