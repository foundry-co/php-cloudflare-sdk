 ...
 * Edit Worker
 */
readonly class EditWorkerRequest
{
	public function __construct(
		...
		public \FoundryCo\Cloudflare\Responses\EditWorkerRequestObservability $observability,
		/** Other resources that reference the Worker and depend on it existing. */
		public \FoundryCo\Cloudflare\Responses\EditWorkerRequestReferences $references,
		/** Subdomain settings for the Worker. */
		public \FoundryCo\Cloudflare\Responses\EditWorkerRequestSubdomain $subdomain,
