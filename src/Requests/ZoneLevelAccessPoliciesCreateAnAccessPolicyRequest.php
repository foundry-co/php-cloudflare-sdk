 ...
 */
readonly class ZoneLevelAccessPoliciesCreateAnAccessPolicyRequest
{
	public function __construct(
		/** The action Access will take if a user matches this policy. */
		public \FoundryCo\Cloudflare\Enums\ZoneLevelAccessPoliciesCreateAnAccessPolicyRequestDecision $decision,
