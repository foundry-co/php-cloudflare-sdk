 ...
 */
readonly class LoadBalancersCreateLoadBalancerRequest
{
	public function __construct(
		/** A list of pool IDs ordered by their failover priority. Pools defined here are used by default, or when region_pools are not configured for a given region. */
		public array $defaultPools,
		...
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersCreateLoadBalancerRequestAdaptiveRouting $adaptiveRouting = null,
		...
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersCreateLoadBalancerRequestLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersCreateLoadBalancerRequestRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersCreateLoadBalancerRequestSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersCreateLoadBalancerRequestSessionAffinityAttributes $sessionAffinityAttributes = null,
		...
		public ?float $sessionAffinityTtl = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersCreateLoadBalancerRequestSteeringPolicy $steeringPolicy = null,
	...
	public function toArray(): array
	{
		return array_filter([
		    ...
		    'name' => $this->name,
		    'adaptive_routing' => $this->adaptiveRouting?->toArray(),
		    'country_pools' => $this->countryPools,
		    'description' => $this->description,
		    'location_strategy' => $this->locationStrategy?->toArray(),
		    'networks' => $this->networks,
		    'pop_pools' => $this->popPools,
		    'proxied' => $this->proxied,
		    'random_steering' => $this->randomSteering?->toArray(),
		    'region_pools' => $this->regionPools,
		    'rules' => $this->rules,
		    'session_affinity' => $this->sessionAffinity?->value,
		    'session_affinity_attributes' => $this->sessionAffinityAttributes?->toArray(),
		    'session_affinity_ttl' => $this->sessionAffinityTtl,
		    'steering_policy' => $this->steeringPolicy?->value,
		    'ttl' => $this->ttl,
		], fn ($v) => $v !== null);
	}
}
