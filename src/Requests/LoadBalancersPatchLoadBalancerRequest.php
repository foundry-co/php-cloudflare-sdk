 ...
 * Patch Load Balancer
 */
readonly class LoadBalancersPatchLoadBalancerRequest
{
	public function __construct(
		/** Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin. */
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersPatchLoadBalancerRequestAdaptiveRouting $adaptiveRouting = null,
		...
		public ?string $fallbackPool = null,
		/** Controls location-based steering for non-proxied requests. See `steering_policy` to learn how steering is affected. */
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersPatchLoadBalancerRequestLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersPatchLoadBalancerRequestRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRequestSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?\FoundryCo\Cloudflare\Responses\LoadBalancersPatchLoadBalancerRequestSessionAffinityAttributes $sessionAffinityAttributes = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRequestSteeringPolicy $steeringPolicy = null,
