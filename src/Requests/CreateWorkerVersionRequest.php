 ...
 * Create Version
 */
readonly class CreateWorkerVersionRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Responses\CreateWorkerVersionRequestAnnotations $annotations = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Responses\CreateWorkerVersionRequestAssets $assets = null,
		...
		public ?\FoundryCo\Cloudflare\Responses\CreateWorkerVersionRequestLimits $limits = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\CreateWorkerVersionRequestUsageModel $usageModel = null,
	) {
	}
	...
	public function toArray(): array
	{
		return array_filter([
		    ...
		    'compatibility_flags' => $this->compatibilityFlags,
		    'containers' => $this->containers,
		    'limits' => $this->limits?->toArray(),
		    'main_module' => $this->mainModule,
		    'migration_tag' => $this->migrationTag,
		    'migrations' => $this->migrations,
		    'modules' => $this->modules,
		    'placement' => $this->placement,
		    'source' => $this->source,
		    'startup_time_ms' => $this->startupTimeMs,
