 ...
 * Create Worker
 */
readonly class CreateWorkerRequest
{
	public function __construct(
		...
		public \FoundryCo\Cloudflare\Responses\CreateWorkerRequestObservability $observability,
		/** Other resources that reference the Worker and depend on it existing. */
		public \FoundryCo\Cloudflare\Responses\CreateWorkerRequestReferences $references,
		/** Subdomain settings for the Worker. */
		public \FoundryCo\Cloudflare\Responses\CreateWorkerRequestSubdomain $subdomain,
