 ...
 * Update Site LAN
 */
readonly class MagicSiteLansUpdateLanRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Responses\MagicSiteLansUpdateLanRequestNat $nat = null,
		public ?int $physport = null,
		public ?array $routedSubnets = null,
		/** If the site is not configured in high availability mode, this configuration is optional (if omitted, use DHCP). However, if in high availability mode, static_address is required along with secondary and virtual address. */
		public ?\FoundryCo\Cloudflare\Responses\MagicSiteLansUpdateLanRequestStaticAddressing $staticAddressing = null,
