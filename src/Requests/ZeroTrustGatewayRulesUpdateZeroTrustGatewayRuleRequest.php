 ...
 */
readonly class ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRequest
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public \FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRequestAction $action,
		...
		public ?\FoundryCo\Cloudflare\Responses\ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRequestExpiration $expiration = null,
		...
		public ?\FoundryCo\Cloudflare\Responses\ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRequestRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?\FoundryCo\Cloudflare\Responses\ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRequestSchedule $schedule = null,
