 ...
 */
readonly class AccessPoliciesUpdateAnAccessPolicyRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Responses\AccessPoliciesUpdateAnAccessPolicyRequestConnectionRules $connectionRules = null,
		/** Require this application to be served in an isolated browser for users matching this policy. 'Client Web Isolation' must be on for the account in order to use this feature. */
		public ?bool $isolationRequired = null,
		/** Configures multi-factor authentication (MFA) settings. */
		public ?\FoundryCo\Cloudflare\Responses\AccessPoliciesUpdateAnAccessPolicyRequestMfaConfig $mfaConfig = null,
