 ...
 * Update Logpush job
 */
readonly class PutAccountsAccountIdLogpushJobsJobIdRequest
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\PutAccountsAccountIdLogpushJobsJobIdRequestFrequency $frequency = null,
		/** The kind parameter (optional) is used to differentiate between Logpush and Edge Log Delivery jobs (when supported by the dataset). */
		public ?\FoundryCo\Cloudflare\Enums\PutAccountsAccountIdLogpushJobsJobIdRequestKind $kind = null,
		...
		public ?\FoundryCo\Cloudflare\Responses\PutAccountsAccountIdLogpushJobsJobIdRequestOutputOptions $outputOptions = null,
