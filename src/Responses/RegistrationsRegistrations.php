...
readonly class RegistrationsRegistrations
{
	public function __construct(
		...
		public ?RegistrationsRegistrationsPolicy $policy = null,
		...
		public ?RegistrationsRegistrationsUser $user = null,
	) {
	}
}
