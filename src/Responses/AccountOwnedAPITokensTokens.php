...
readonly class AccountOwnedAPITokensTokens
{
	public function __construct(
		public ?AccountOwnedAPITokensTokensCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\AccountOwnedAPITokensTokensStatus $status = null,
	) {
	}
}
