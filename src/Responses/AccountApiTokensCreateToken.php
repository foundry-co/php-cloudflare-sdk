...
readonly class AccountApiTokensCreateToken
{
	public function __construct(
		public ?AccountApiTokensCreateTokenCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\AccountApiTokensCreateTokenStatus $status = null,
		/** The token value. */
