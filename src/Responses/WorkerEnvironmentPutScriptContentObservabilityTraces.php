 ...
 */
readonly class WorkerEnvironmentPutScriptContentObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerEnvironmentPutScriptContentObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
