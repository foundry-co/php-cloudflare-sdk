...
readonly class PagesProjectProjectCanonicalDeploymentSourceConfig
{
	public function __construct(
		 ...
		 */
		public bool $deploymentsEnabled,
		...
		public array $previewBranchExcludes,
		...
		public array $previewBranchIncludes,
		/** Controls whether commits to preview branches trigger a preview deployment. */
		public \FoundryCo\Cloudflare\Enums\PagesProjectProjectCanonicalDeploymentSourceConfigPreviewDeploymentSetting $previewDeploymentSetting,
		/** The production branch of the repository. */
		public string $productionBranch,
		/** Whether to trigger a production deployment on commits to the production branch. */
		public bool $productionDeploymentsEnabled,
