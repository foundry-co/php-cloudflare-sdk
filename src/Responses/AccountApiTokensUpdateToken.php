...
readonly class AccountApiTokensUpdateToken
{
	public function __construct(
		public ?AccountApiTokensUpdateTokenCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\AccountApiTokensUpdateTokenStatus $status = null,
	) {
	}
}
