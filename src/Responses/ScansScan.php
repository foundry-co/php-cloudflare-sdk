...
readonly class ScansScan
{
	public function __construct(
		/** Scan identifier. */
		public string $id,
		/** The type of vulnerability scan. */
		public \FoundryCo\Cloudflare\Enums\ScansScanScanType $scanType,
		/** Current lifecycle status of the scan. */
		public \FoundryCo\Cloudflare\Enums\ScansScanStatus $status,
		...
		public ?ScansScanReport $report = null,
	) {
	}
}
