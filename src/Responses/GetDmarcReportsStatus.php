 ...
 */
readonly class GetDmarcReportsStatus
{
	public function __construct(
		...
		public ?GetDmarcReportsStatusRecords $records = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\GetDmarcReportsStatusStatus $status = null,
		/** Use `zone_id` instead */
