 ...
 */
readonly class BillableUsageV2GetOrganizationUsage
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\BillableUsageV2GetOrganizationUsageChargeCategory $chargeCategory = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\BillableUsageV2GetOrganizationUsageChargeFrequency $chargeFrequency = null,
		...
		public ?string $hostProviderName = null,
		/** Name of the entity responsible for invoicing for the services consumed. */
		public ?string $invoiceIssuerName = null,
		...
		public ?string $xBillableMetricName = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\BillableUsageV2GetOrganizationUsageChargeClass $chargeClass = null,
