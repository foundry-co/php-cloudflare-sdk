 ...
 */
readonly class NamespaceWorkerScriptWorkerDetailsScriptObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\NamespaceWorkerScriptWorkerDetailsScriptObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
