 ...
 */
readonly class EmailSecurityCreateImpersonationRegistry
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\EmailSecurityCreateImpersonationRegistryProvenance $provenance = null,
	) {
	}
}
