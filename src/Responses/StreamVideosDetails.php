...
readonly class StreamVideosDetails
{
	public function __construct(
		...
		public ?StreamVideosDetailsInput $input = null,
		...
		public ?StreamVideosDetailsPlayback $playback = null,
		/** The video's preview page URI. This field is omitted until encoding is complete. */
		public ?string $preview = null,
		/** Public details for the video including title, share link, channel link, and logo. */
		public ?StreamVideosDetailsPublicDetails $publicDetails = null,
		...
		public ?StreamVideosDetailsStatus $status = null,
		...
		public ?StreamVideosDetailsWatermark $watermark = null,
	) {
	}
}
