...
readonly class AiSearchUpdateInstanceRequestRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchUpdateInstanceRequestRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
