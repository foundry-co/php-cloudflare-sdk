...
readonly class NamespaceWorkerListScriptsScript
{
	public function __construct(
		...
		public ?NamespaceWorkerListScriptsScriptObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?NamespaceWorkerListScriptsScriptPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\NamespaceWorkerListScriptsScriptUsageModel $usageModel = null,
	) {
	}
}
