...
readonly class RequestReview
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\RequestReviewEntityType $entityType = null,
		/** ID of remediation. */
		public ?string $id = null,
		/** The status of a mitigation */
		public ?\FoundryCo\Cloudflare\Enums\RequestReviewStatus $status = null,
		/** The type of mitigation applied to a reported entity. */
		public ?\FoundryCo\Cloudflare\Enums\RequestReviewType $type = null,
	) {
	}
}
