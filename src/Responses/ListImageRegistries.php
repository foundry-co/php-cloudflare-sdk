 ...
 */
readonly class ListImageRegistries
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\ListImageRegistriesKind $kind = null,
		/** A reference to a secret stored in Secrets Store */
		public ?ListImageRegistriesPrivateCredential $privateCredential = null,
