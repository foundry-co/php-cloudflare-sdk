 ...
 */
readonly class UpdateTableMaintenanceConfigSnapshotExpiration
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\UpdateTableMaintenanceConfigSnapshotExpirationState $state = null,
	) {
	}
}
