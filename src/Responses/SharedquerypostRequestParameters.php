 ...
 */
readonly class SharedquerypostRequestParameters
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\SharedquerypostRequestParametersFilterCombination $filterCombination = null,
		...
		public ?SharedquerypostRequestParametersNeedle $needle = null,
		/** Ordering for grouped calculation results. Only effective when a group-by is present. */
		public ?SharedquerypostRequestParametersOrderBy $orderBy = null,
	) {
	}
}
