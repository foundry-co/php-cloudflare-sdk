...
readonly class AiSearchNamespaceListInstancesRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchNamespaceListInstancesRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
