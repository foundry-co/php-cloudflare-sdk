...
readonly class MagicIPsecTunnelsDetailsIpsecTunnel
{
	public function __construct(
		...
		public ?MagicIPsecTunnelsDetailsIpsecTunnelBgp $bgp = null,
		public ?MagicIPsecTunnelsDetailsIpsecTunnelBgpStatus $bgpStatus = null,
		/** The date and time the tunnel was created. */
		public ?\DateTimeImmutable $createdOn = null,
		public ?MagicIPsecTunnelsDetailsIpsecTunnelCustomRemoteIdentities $customRemoteIdentities = null,
		/** The IP address assigned to the customer side of the IPsec tunnel. Not required, but must be set for proactive traceroutes to work. */
		public ?string $customerEndpoint = null,
		/** An optional description forthe IPsec tunnel. */
		public ?string $description = null,
		public ?MagicIPsecTunnelsDetailsIpsecTunnelHealthCheck $healthCheck = null,
		/** A 127 bit IPV6 prefix from within the virtual_subnet6 prefix space with the address being the first IP of the subnet and not same as the address of virtual_subnet6. Eg if virtual_subnet6 is 2606:54c1:7:0:a9fe:12d2::/127 , interface_address6 could be 2606:54c1:7:0:a9fe:12d2:1:200/127 */
		public ?string $interfaceAddress6 = null,
		/** The date and time the tunnel was last modified. */
		public ?\DateTimeImmutable $modifiedOn = null,
		/** The PSK metadata that includes when the PSK was generated. */
		public ?MagicIPsecTunnelsDetailsIpsecTunnelPskMetadata $pskMetadata = null,
