...
readonly class AiSearchListInstancesRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchListInstancesRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
