 ...
 */
readonly class ListApplicationVersionsConfiguration
{
	public function __construct(
		...
		public ?ListApplicationVersionsConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?ListApplicationVersionsConfigurationDns $dns = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ListApplicationVersionsConfigurationInstanceType $instanceType = null,
		/** Deployment labels */
		public ?array $labels = null,
		/** Lifecycle configuration for a deployment. */
		public ?ListApplicationVersionsConfigurationLifecycle $lifecycle = null,
		...
		public ?ListApplicationVersionsConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?ListApplicationVersionsConfigurationObservability $observability = null,
		...
		public ?ListApplicationVersionsConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
