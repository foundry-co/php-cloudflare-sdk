...
readonly class UserAPITokensDetails
{
	public function __construct(
		public ?UserAPITokensDetailsCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\UserAPITokensDetailsStatus $status = null,
	) {
	}
}
