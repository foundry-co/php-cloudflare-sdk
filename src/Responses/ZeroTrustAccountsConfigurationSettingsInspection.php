 ...
 */
readonly class ZeroTrustAccountsConfigurationSettingsInspection
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustAccountsConfigurationSettingsInspectionMode $mode = null,
	) {
	}
}
