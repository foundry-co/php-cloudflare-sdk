 ...
 */
readonly class ModifyApplicationConfiguration
{
	public function __construct(
		...
		public ?ModifyApplicationConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?ModifyApplicationConfigurationDns $dns = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ModifyApplicationConfigurationInstanceType $instanceType = null,
		/** Deployment labels */
		public ?array $labels = null,
		/** Lifecycle configuration for a deployment. */
		public ?ModifyApplicationConfigurationLifecycle $lifecycle = null,
		...
		public ?ModifyApplicationConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?ModifyApplicationConfigurationObservability $observability = null,
		...
		public ?ModifyApplicationConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
