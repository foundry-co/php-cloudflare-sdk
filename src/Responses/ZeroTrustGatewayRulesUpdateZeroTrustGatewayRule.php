...
readonly class ZeroTrustGatewayRulesUpdateZeroTrustGatewayRule
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleAction $action = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleExpiration $expiration = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleSchedule $schedule = null,
