 ...
 */
readonly class ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
