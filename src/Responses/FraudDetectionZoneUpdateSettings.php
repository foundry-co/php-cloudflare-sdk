...
readonly class FraudDetectionZoneUpdateSettings
{
	public function __construct(
		 ...
		 */
		public ?FraudDetectionZoneUpdateSettingsAuthenticationSettings $authenticationSettings = null,
		/** Whether Fraud User Profiles is enabled for the zone. */
		public ?\FoundryCo\Cloudflare\Enums\FraudDetectionZoneUpdateSettingsUserProfiles $userProfiles = null,
		/**
