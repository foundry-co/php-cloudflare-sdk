 ...
 */
readonly class R2CatalogManagementDetails
{
	public function __construct(
		...
		public \FoundryCo\Cloudflare\Enums\R2CatalogManagementDetailsStatus $status,
		/** Shows the credential configuration status. */
		public mixed $credentialStatus = null,
		/** Configures maintenance for the catalog. */
		public ?R2CatalogManagementDetailsMaintenanceConfig $maintenanceConfig = null,
	) {
	}
}
