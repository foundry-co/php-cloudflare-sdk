 ...
 */
readonly class WorkerScriptSettingsPatchSettingsRequestObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptSettingsPatchSettingsRequestObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
