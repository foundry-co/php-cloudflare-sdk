 ...
 */
readonly class GetCatalogDetails
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\GetCatalogDetailsStatus $status = null,
		/** Shows the credential configuration status. */
		public mixed $credentialStatus = null,
		/** Configures maintenance for the catalog. */
		public ?GetCatalogDetailsMaintenanceConfig $maintenanceConfig = null,
	) {
	}
}
