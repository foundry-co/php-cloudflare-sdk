...
readonly class UserAPITokensToken
{
	public function __construct(
		public ?UserAPITokensTokenCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\UserAPITokensTokenStatus $status = null,
		/** The token value. */
