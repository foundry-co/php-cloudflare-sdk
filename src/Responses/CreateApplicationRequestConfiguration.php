 ...
 */
readonly class CreateApplicationRequestConfiguration
{
	public function __construct(
		...
		public ?CreateApplicationRequestConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?CreateApplicationRequestConfigurationDns $dns = null,
		/**
		...
		public ?CreateApplicationRequestConfigurationLifecycle $lifecycle = null,
		...
		public ?CreateApplicationRequestConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?CreateApplicationRequestConfigurationObservability $observability = null,
		...
		public ?CreateApplicationRequestConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
