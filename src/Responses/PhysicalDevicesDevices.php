 ...
 * A WARP Device.
 */
readonly class PhysicalDevicesDevices
{
	public function __construct(
		...
		public ?PhysicalDevicesDevicesLastSeenRegistration $lastSeenRegistration = null,
		/** The last user to use the WARP device. */
		public ?PhysicalDevicesDevicesLastSeenUser $lastSeenUser = null,
