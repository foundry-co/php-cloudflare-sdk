...
readonly class EmailSecurityMessage
{
	public function __construct(
		...
		public EmailSecurityMessageProperties $properties,
		/** Deprecated, use `scanned_at` instead. End of life: November 1, 2026. */
		public string $ts,
		public ?string $alertId = null,
		public ?\FoundryCo\Cloudflare\Enums\EmailSecurityMessageDeliveryMode $deliveryMode = null,
		public ?array $deliveryStatus = null,
		public ?string $edfHash = null,
		public ?string $envelopeFrom = null,
		public ?array $envelopeTo = null,
		public ?\FoundryCo\Cloudflare\Enums\EmailSecurityMessageFinalDisposition $finalDisposition = null,
		...
		public ?EmailSecurityMessageValidation $validation = null,
