...
readonly class AiSearchNamespaceDeleteInstanceRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchNamespaceDeleteInstanceRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
