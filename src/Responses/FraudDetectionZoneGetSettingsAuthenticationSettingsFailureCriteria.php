...
readonly class FraudDetectionZoneGetSettingsAuthenticationSettingsFailureCriteria
{
	public function __construct(
		/** The type of criterion. Currently only `status_code` is supported. */
		public ?\FoundryCo\Cloudflare\Enums\FraudDetectionZoneGetSettingsAuthenticationSettingsFailureCriteriaKind $kind = null,
		/**
