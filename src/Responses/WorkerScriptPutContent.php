...
readonly class WorkerScriptPutContent
{
	public function __construct(
		...
		public ?WorkerScriptPutContentObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkerScriptPutContentPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptPutContentUsageModel $usageModel = null,
	) {
	}
}
