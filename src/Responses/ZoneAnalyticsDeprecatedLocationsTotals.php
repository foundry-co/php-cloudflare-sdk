 ...
 */
readonly class ZoneAnalyticsDeprecatedLocationsTotals
{
	public function __construct(
		/** Breakdown of totals for bandwidth in the form of bytes. */
		public ?ZoneAnalyticsDeprecatedLocationsTotalsBandwidth $bandwidth = null,
		/** Breakdown of totals for requests. */
		public ?ZoneAnalyticsDeprecatedLocationsTotalsRequests $requests = null,
		/**
		...
		public ?ZoneAnalyticsDeprecatedLocationsTotalsThreats $threats = null,
