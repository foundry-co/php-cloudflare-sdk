...
readonly class AiSearchNamespaceCreateInstanceRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchNamespaceCreateInstanceRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
