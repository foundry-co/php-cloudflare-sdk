 ...
 */
readonly class GetCatalogDetailsMaintenanceConfigSnapshotExpiration
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\GetCatalogDetailsMaintenanceConfigSnapshotExpirationState $state = null,
	) {
	}
}
