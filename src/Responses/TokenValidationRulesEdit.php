 ...
 */
readonly class TokenValidationRulesEdit
{
	public function __construct(
		/** Action to take on requests that match operations included in `selector` and fail `expression`. */
		public ?\FoundryCo\Cloudflare\Enums\TokenValidationRulesEditAction $action = null,
		 ...
		 */
		public ?TokenValidationRulesEditSelector $selector = null,
