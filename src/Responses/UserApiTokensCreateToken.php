...
readonly class UserApiTokensCreateToken
{
	public function __construct(
		public ?UserApiTokensCreateTokenCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\UserApiTokensCreateTokenStatus $status = null,
		/** The token value. */
