 ...
 */
readonly class AccountsLogsExplorerDatasetsAvailableList
{
	public function __construct(
		/** Dataset type name (e.g. `http_requests`). */
		public ?string $dataset = null,
		/** Whether this dataset type is account-scoped or zone-scoped. */
		public ?\FoundryCo\Cloudflare\Enums\AccountsLogsExplorerDatasetsAvailableListObjectType $objectType = null,
		/** JSON Schema that describes the fields this dataset exposes. */
		public ?AccountsLogsExplorerDatasetsAvailableListSchema $schema = null,
