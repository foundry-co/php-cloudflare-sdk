 ...
 */
readonly class ZoneAnalyticsDeprecatedGetDashboardTotals
{
	public function __construct(
		/** Breakdown of totals for bandwidth in the form of bytes. */
		public ?ZoneAnalyticsDeprecatedGetDashboardTotalsBandwidth $bandwidth = null,
		/** Breakdown of totals for pageviews. */
		public ?ZoneAnalyticsDeprecatedGetDashboardTotalsPageviews $pageviews = null,
		/** Breakdown of totals for requests. */
		public ?ZoneAnalyticsDeprecatedGetDashboardTotalsRequests $requests = null,
		/**
		...
		public ?ZoneAnalyticsDeprecatedGetDashboardTotalsThreats $threats = null,
		public ?ZoneAnalyticsDeprecatedGetDashboardTotalsUniques $uniques = null,
