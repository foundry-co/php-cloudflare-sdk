...
readonly class LoadBalancersListLoadBalancers
{
	public function __construct(
		/** Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin. */
		public ?LoadBalancersListLoadBalancersAdaptiveRouting $adaptiveRouting = null,
		...
		public ?LoadBalancersListLoadBalancersLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?LoadBalancersListLoadBalancersRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersListLoadBalancersSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?LoadBalancersListLoadBalancersSessionAffinityAttributes $sessionAffinityAttributes = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersListLoadBalancersSteeringPolicy $steeringPolicy = null,
