 ...
 */
readonly class ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesTenantRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
