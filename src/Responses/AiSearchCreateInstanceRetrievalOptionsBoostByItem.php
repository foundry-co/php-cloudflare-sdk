...
readonly class AiSearchCreateInstanceRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchCreateInstanceRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
