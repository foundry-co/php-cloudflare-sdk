 ...
 */
readonly class ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
