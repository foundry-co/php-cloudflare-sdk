...
readonly class WorkerScriptWorkers
{
	public function __construct(
		...
		public ?WorkerScriptWorkersObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkerScriptWorkersPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptWorkersUsageModel $usageModel = null,
