...
readonly class ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleAction $action = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleExpiration $expiration = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleSchedule $schedule = null,
