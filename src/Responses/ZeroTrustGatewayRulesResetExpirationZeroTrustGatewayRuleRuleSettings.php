 ...
 */
readonly class ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesResetExpirationZeroTrustGatewayRuleRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
