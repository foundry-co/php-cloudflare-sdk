...
readonly class UserApiTokensTokenDetails
{
	public function __construct(
		public ?UserApiTokensTokenDetailsCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\UserApiTokensTokenDetailsStatus $status = null,
	) {
	}
}
