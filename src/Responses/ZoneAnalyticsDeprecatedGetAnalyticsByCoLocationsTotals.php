 ...
 */
readonly class ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTotals
{
	public function __construct(
		/** Breakdown of totals for bandwidth in the form of bytes. */
		public ?ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTotalsBandwidth $bandwidth = null,
		/** Breakdown of totals for requests. */
		public ?ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTotalsRequests $requests = null,
		/**
		...
		public ?ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTotalsThreats $threats = null,
