...
readonly class GetApplication
{
	public function __construct(
		...
		public ?GetApplicationConfiguration $configuration = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\GetApplicationSchedulingPolicy $schedulingPolicy = null,
		/** UTC timestamp string in ISO 8601 format */
		public ?string $updatedAt = null,
		public ?int $version = null,
		/** An identifier for a specific rollout within an application. */
		public ?string $activeRolloutId = null,
		public ?GetApplicationConstraints $constraints = null,
		/** Durable object configuration using a namespace ID */
		public ?GetApplicationDurableObjects $durableObjects = null,
		public ?GetApplicationHealth $health = null,
		...
		public ?GetApplicationObservability $observability = null,
		/**
