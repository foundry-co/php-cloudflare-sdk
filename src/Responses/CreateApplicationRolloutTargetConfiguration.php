 ...
 */
readonly class CreateApplicationRolloutTargetConfiguration
{
	public function __construct(
		...
		public ?CreateApplicationRolloutTargetConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?CreateApplicationRolloutTargetConfigurationDns $dns = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\CreateApplicationRolloutTargetConfigurationInstanceType $instanceType = null,
		/** Deployment labels */
		public ?array $labels = null,
		/** Lifecycle configuration for a deployment. */
		public ?CreateApplicationRolloutTargetConfigurationLifecycle $lifecycle = null,
		...
		public ?CreateApplicationRolloutTargetConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?CreateApplicationRolloutTargetConfigurationObservability $observability = null,
		...
		public ?CreateApplicationRolloutTargetConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
