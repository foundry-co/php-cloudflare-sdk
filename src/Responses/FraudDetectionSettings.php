...
readonly class FraudDetectionSettings
{
	public function __construct(
		 ...
		 */
		public ?FraudDetectionSettingsAuthenticationSettings $authenticationSettings = null,
		/** Whether Fraud User Profiles is enabled for the zone. */
		public ?\FoundryCo\Cloudflare\Enums\FraudDetectionSettingsUserProfiles $userProfiles = null,
		/**
