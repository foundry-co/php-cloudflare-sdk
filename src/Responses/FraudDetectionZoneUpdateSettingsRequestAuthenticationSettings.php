 ...
 */
readonly class FraudDetectionZoneUpdateSettingsRequestAuthenticationSettings
{
	public function __construct(
		/** Criterion for identifying failed login responses. */
		public ?FraudDetectionZoneUpdateSettingsRequestAuthenticationSettingsFailureCriteria $failureCriteria = null,
		/** Criterion for identifying successful login responses. */
		public ?FraudDetectionZoneUpdateSettingsRequestAuthenticationSettingsSuccessCriteria $successCriteria = null,
	) {
	}
}
