...
readonly class WorkersListWorkers
{
	public function __construct(
		...
		public WorkersListWorkersObservability $observability,
		/** Other resources that reference the Worker and depend on it existing. */
		public WorkersListWorkersReferences $references,
		/** Subdomain settings for the Worker. */
		public WorkersListWorkersSubdomain $subdomain,
