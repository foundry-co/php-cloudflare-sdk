 ...
 */
readonly class LoadBalancersCreateLoadBalancerRulesItemOverrides
{
	public function __construct(
		/** Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin. */
		public ?LoadBalancersCreateLoadBalancerRulesItemOverridesAdaptiveRouting $adaptiveRouting = null,
		...
		public ?LoadBalancersCreateLoadBalancerRulesItemOverridesLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?LoadBalancersCreateLoadBalancerRulesItemOverridesRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersCreateLoadBalancerRulesItemOverridesSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?LoadBalancersCreateLoadBalancerRulesItemOverridesSessionAffinityAttributes $sessionAffinityAttributes = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersCreateLoadBalancerRulesItemOverridesSteeringPolicy $steeringPolicy = null,
