 ...
 */
readonly class ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
