 ...
 */
readonly class CloudflareTunnelConfigurationPutConfigurationConfigOriginRequest
{
	public function __construct(
		/** For all L7 requests to this hostname, cloudflared will validate each request's Cf-Access-Jwt-Assertion request header. */
		public ?CloudflareTunnelConfigurationPutConfigurationConfigOriginRequestAccess $access = null,
