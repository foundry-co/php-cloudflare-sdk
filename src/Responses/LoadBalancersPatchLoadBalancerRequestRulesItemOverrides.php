 ...
 */
readonly class LoadBalancersPatchLoadBalancerRequestRulesItemOverrides
{
	public function __construct(
		/** Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin. */
		public ?LoadBalancersPatchLoadBalancerRequestRulesItemOverridesAdaptiveRouting $adaptiveRouting = null,
		...
		public ?LoadBalancersPatchLoadBalancerRequestRulesItemOverridesLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?LoadBalancersPatchLoadBalancerRequestRulesItemOverridesRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRequestRulesItemOverridesSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?LoadBalancersPatchLoadBalancerRequestRulesItemOverridesSessionAffinityAttributes $sessionAffinityAttributes = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRequestRulesItemOverridesSteeringPolicy $steeringPolicy = null,
