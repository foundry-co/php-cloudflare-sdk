 ...
 */
readonly class LoadBalancersPatchLoadBalancerRulesItemOverridesSessionAffinityAttributes
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRulesItemOverridesSessionAffinityAttributesSamesite $samesite = null,
		/** Configures the Secure attribute on session affinity cookie. Value "Always" indicates the Secure attribute will be set in the Set-Cookie header, "Never" indicates the Secure attribute will not be set, and "Auto" will set the Secure attribute depending if Always Use HTTPS is enabled. */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRulesItemOverridesSessionAffinityAttributesSecure $secure = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover $zeroDowntimeFailover = null,
	) {
	}
}
