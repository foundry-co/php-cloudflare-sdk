 ...
 */
readonly class ListCatalogsWarehousesItemMaintenanceConfigSnapshotExpiration
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\ListCatalogsWarehousesItemMaintenanceConfigSnapshotExpirationState $state = null,
	) {
	}
}
