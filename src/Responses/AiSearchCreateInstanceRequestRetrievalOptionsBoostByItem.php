...
readonly class AiSearchCreateInstanceRequestRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchCreateInstanceRequestRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
