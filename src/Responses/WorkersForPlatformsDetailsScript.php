...
readonly class WorkersForPlatformsDetailsScript
{
	public function __construct(
		...
		public ?WorkersForPlatformsDetailsScriptObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkersForPlatformsDetailsScriptPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkersForPlatformsDetailsScriptUsageModel $usageModel = null,
	) {
	}
}
