 ...
 */
readonly class LoadBalancersBalancersSessionAffinityAttributes
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersBalancersSessionAffinityAttributesSamesite $samesite = null,
		/** Configures the Secure attribute on session affinity cookie. Value "Always" indicates the Secure attribute will be set in the Set-Cookie header, "Never" indicates the Secure attribute will not be set, and "Auto" will set the Secure attribute depending if Always Use HTTPS is enabled. */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersBalancersSessionAffinityAttributesSecure $secure = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersBalancersSessionAffinityAttributesZeroDowntimeFailover $zeroDowntimeFailover = null,
	) {
	}
}
