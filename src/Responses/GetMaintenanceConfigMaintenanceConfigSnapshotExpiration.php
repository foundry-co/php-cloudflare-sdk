 ...
 */
readonly class GetMaintenanceConfigMaintenanceConfigSnapshotExpiration
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\GetMaintenanceConfigMaintenanceConfigSnapshotExpirationState $state = null,
	) {
	}
}
