...
readonly class WorkerEnvironmentContent
{
	public function __construct(
		...
		public ?WorkerEnvironmentContentObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkerEnvironmentContentPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerEnvironmentContentUsageModel $usageModel = null,
	) {
	}
}
