 ...
 */
readonly class OriginCloudRegionsBatchUpsert
{
	public function __construct(
		/** Whether the setting can be modified by the current user. */
		public ?bool $editable = null,
		public ?\FoundryCo\Cloudflare\Enums\OriginCloudRegionsBatchUpsertId $id = null,
		public ?OriginCloudRegionsBatchUpsertValue $value = null,
