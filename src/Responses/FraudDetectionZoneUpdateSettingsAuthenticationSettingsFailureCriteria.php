...
readonly class FraudDetectionZoneUpdateSettingsAuthenticationSettingsFailureCriteria
{
	public function __construct(
		/** The type of criterion. Currently only `status_code` is supported. */
		public ?\FoundryCo\Cloudflare\Enums\FraudDetectionZoneUpdateSettingsAuthenticationSettingsFailureCriteriaKind $kind = null,
		/**
