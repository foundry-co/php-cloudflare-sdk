...
readonly class DomainIntelligenceGetDomainDetails
{
	public function __construct(
		/** Additional information related to the host name. */
		public ?DomainIntelligenceGetDomainDetailsAdditionalInformation $additionalInformation = null,
		/** Application that the hostname belongs to. */
		public ?DomainIntelligenceGetDomainDetailsApplication $application = null,
