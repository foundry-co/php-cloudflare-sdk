 ...
 */
readonly class WorkerScriptEnvironmentPatchSettingsObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptEnvironmentPatchSettingsObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
