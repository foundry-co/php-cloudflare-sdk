...
readonly class WorkersCreateWorker
{
	public function __construct(
		...
		public WorkersCreateWorkerObservability $observability,
		/** Other resources that reference the Worker and depend on it existing. */
		public WorkersCreateWorkerReferences $references,
		/** Subdomain settings for the Worker. */
		public WorkersCreateWorkerSubdomain $subdomain,
