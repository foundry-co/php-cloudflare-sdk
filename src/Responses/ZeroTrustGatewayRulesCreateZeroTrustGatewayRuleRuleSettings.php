 ...
 */
readonly class ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
