...
readonly class GetApplicationHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ?GetApplicationHealthInstances $instances = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\GetApplicationHealthSummary $summary = null,
	) {
	}
}
