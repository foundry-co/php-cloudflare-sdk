...
readonly class WorkersForPlatformsScriptsScript
{
	public function __construct(
		...
		public ?WorkersForPlatformsScriptsScriptObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkersForPlatformsScriptsScriptPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkersForPlatformsScriptsScriptUsageModel $usageModel = null,
	) {
	}
}
