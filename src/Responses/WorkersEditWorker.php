...
readonly class WorkersEditWorker
{
	public function __construct(
		...
		public WorkersEditWorkerObservability $observability,
		/** Other resources that reference the Worker and depend on it existing. */
		public WorkersEditWorkerReferences $references,
		/** Subdomain settings for the Worker. */
		public WorkersEditWorkerSubdomain $subdomain,
