...
readonly class AiSearchNamespaceFetchInstanceRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchNamespaceFetchInstanceRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
