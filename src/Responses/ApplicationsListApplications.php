 ...
 */
readonly class ApplicationsListApplications
{
	public function __construct(
		...
		public ApplicationsListApplicationsConfiguration $configuration,
		...
		public \FoundryCo\Cloudflare\Enums\ApplicationsListApplicationsSchedulingPolicy $schedulingPolicy,
		/** UTC timestamp string in ISO 8601 format */
		public string $updatedAt,
		public int $version,
		/** An identifier for a specific rollout within an application. */
		public ?string $activeRolloutId = null,
		public ?ApplicationsListApplicationsConstraints $constraints = null,
		/** Durable object configuration using a namespace ID */
		public ?ApplicationsListApplicationsDurableObjects $durableObjects = null,
		public ?ApplicationsListApplicationsHealth $health = null,
		...
		public ?ApplicationsListApplicationsObservability $observability = null,
		/**
