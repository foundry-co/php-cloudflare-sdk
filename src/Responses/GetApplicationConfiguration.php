 ...
 */
readonly class GetApplicationConfiguration
{
	public function __construct(
		...
		public ?GetApplicationConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?GetApplicationConfigurationDns $dns = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\GetApplicationConfigurationInstanceType $instanceType = null,
		/** Deployment labels */
		public ?array $labels = null,
		/** Lifecycle configuration for a deployment. */
		public ?GetApplicationConfigurationLifecycle $lifecycle = null,
		...
		public ?GetApplicationConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?GetApplicationConfigurationObservability $observability = null,
		...
		public ?GetApplicationConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
