 ...
 */
readonly class SharedSharedquerygetRun
{
	public function __construct(
		...
		public SharedSharedquerygetRunQuery $query,
		/** Current execution status of the query run. */
		public \FoundryCo\Cloudflare\Enums\SharedSharedquerygetRunStatus $status,
		/** Time range for the query execution */
		public SharedSharedquerygetRunTimeframe $timeframe,
		...
		public ?SharedSharedquerygetRunStatistics $statistics = null,
