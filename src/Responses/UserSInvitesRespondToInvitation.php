...
readonly class UserSInvitesRespondToInvitation
{
	public function __construct(
		/** ID of the user to add to the organization. */
		public ?string $invitedMemberId = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\UserSInvitesRespondToInvitationStatus $status = null,
	) {
	}
}
