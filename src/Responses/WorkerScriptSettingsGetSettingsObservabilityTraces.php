 ...
 */
readonly class WorkerScriptSettingsGetSettingsObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptSettingsGetSettingsObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
