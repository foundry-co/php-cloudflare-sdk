...
readonly class ZoneAnalyticsDeprecatedGetDashboardTimeseriesItem
{
	public function __construct(
		/** Breakdown of totals for bandwidth in the form of bytes. */
		public ?ZoneAnalyticsDeprecatedGetDashboardTimeseriesItemBandwidth $bandwidth = null,
		/** Breakdown of totals for pageviews. */
		public ?ZoneAnalyticsDeprecatedGetDashboardTimeseriesItemPageviews $pageviews = null,
		/** Breakdown of totals for requests. */
		public ?ZoneAnalyticsDeprecatedGetDashboardTimeseriesItemRequests $requests = null,
		/**
		...
		public ?ZoneAnalyticsDeprecatedGetDashboardTimeseriesItemThreats $threats = null,
		public ?ZoneAnalyticsDeprecatedGetDashboardTimeseriesItemUniques $uniques = null,
