...
readonly class AiSearchNamespaceCreateInstanceRetrievalOptions
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchNamespaceCreateInstanceRetrievalOptionsKeywordMatchMode $keywordMatchMode = null,
	) {
	}
}
