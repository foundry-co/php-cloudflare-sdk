...
readonly class UpdateWorker
{
	public function __construct(
		...
		public ?UpdateWorkerObservability $observability = null,
		/** Other resources that reference the Worker and depend on it existing. */
		public ?UpdateWorkerReferences $references = null,
		/** Subdomain settings for the Worker. */
		public ?UpdateWorkerSubdomain $subdomain = null,
