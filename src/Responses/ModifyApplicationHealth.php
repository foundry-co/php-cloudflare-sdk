...
readonly class ModifyApplicationHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ?ModifyApplicationHealthInstances $instances = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ModifyApplicationHealthSummary $summary = null,
	) {
	}
}
