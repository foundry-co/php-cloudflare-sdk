 ...
 */
readonly class TokenValidationRulesGet
{
	public function __construct(
		/** Action to take on requests that match operations included in `selector` and fail `expression`. */
		public ?\FoundryCo\Cloudflare\Enums\TokenValidationRulesGetAction $action = null,
		 ...
		 */
		public ?TokenValidationRulesGetSelector $selector = null,
