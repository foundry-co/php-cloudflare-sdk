 ...
 */
readonly class ZeroTrustGatewayRulesTenantRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesTenantRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesTenantRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesTenantRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesTenantRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesTenantRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
