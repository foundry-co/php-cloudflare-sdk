...
readonly class WorkersUpdateWorker
{
	public function __construct(
		...
		public WorkersUpdateWorkerObservability $observability,
		/** Other resources that reference the Worker and depend on it existing. */
		public WorkersUpdateWorkerReferences $references,
		/** Subdomain settings for the Worker. */
		public WorkersUpdateWorkerSubdomain $subdomain,
