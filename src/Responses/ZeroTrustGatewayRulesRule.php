...
readonly class ZeroTrustGatewayRulesRule
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public \FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesRuleAction $action,
		...
		public ?ZeroTrustGatewayRulesRuleExpiration $expiration = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?ZeroTrustGatewayRulesRuleSchedule $schedule = null,
