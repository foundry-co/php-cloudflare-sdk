...
readonly class ZeroTrustRiskScoringIntegrationsUpdate
{
	public function __construct(
		...
		public string $id,
		public \FoundryCo\Cloudflare\Enums\ZeroTrustRiskScoringIntegrationsUpdateIntegrationType $integrationType,
		/**
