 ...
 */
readonly class ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesPatchMultipleZeroTrustGatewayRulesRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
