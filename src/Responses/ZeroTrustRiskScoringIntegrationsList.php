...
readonly class ZeroTrustRiskScoringIntegrationsList
{
	public function __construct(
		...
		public string $id,
		public \FoundryCo\Cloudflare\Enums\ZeroTrustRiskScoringIntegrationsListIntegrationType $integrationType,
		/**
