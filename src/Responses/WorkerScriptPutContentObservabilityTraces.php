 ...
 */
readonly class WorkerScriptPutContentObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptPutContentObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
