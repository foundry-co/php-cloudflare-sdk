 ...
 */
readonly class SharedquerygetRun
{
	public function __construct(
		...
		public ?SharedquerygetRunQuery $query = null,
		/** Current execution status of the query run. */
		public ?\FoundryCo\Cloudflare\Enums\SharedquerygetRunStatus $status = null,
		/** Time range for the query execution */
		public ?SharedquerygetRunTimeframe $timeframe = null,
		...
		public ?SharedquerygetRunStatistics $statistics = null,
