 ...
 */
readonly class LoadBalancersLoadBalancerDetailsRulesItemOverrides
{
	public function __construct(
		/** Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin. */
		public ?LoadBalancersLoadBalancerDetailsRulesItemOverridesAdaptiveRouting $adaptiveRouting = null,
		...
		public ?LoadBalancersLoadBalancerDetailsRulesItemOverridesLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?LoadBalancersLoadBalancerDetailsRulesItemOverridesRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersLoadBalancerDetailsRulesItemOverridesSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?LoadBalancersLoadBalancerDetailsRulesItemOverridesSessionAffinityAttributes $sessionAffinityAttributes = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersLoadBalancerDetailsRulesItemOverridesSteeringPolicy $steeringPolicy = null,
