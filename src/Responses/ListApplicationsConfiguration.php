 ...
 */
readonly class ListApplicationsConfiguration
{
	public function __construct(
		...
		public ?ListApplicationsConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?ListApplicationsConfigurationDns $dns = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ListApplicationsConfigurationInstanceType $instanceType = null,
		/** Deployment labels */
		public ?array $labels = null,
		/** Lifecycle configuration for a deployment. */
		public ?ListApplicationsConfigurationLifecycle $lifecycle = null,
		...
		public ?ListApplicationsConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?ListApplicationsConfigurationObservability $observability = null,
		...
		public ?ListApplicationsConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
