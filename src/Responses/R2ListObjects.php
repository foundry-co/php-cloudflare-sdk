...
readonly class R2ListObjects
{
	public function __construct(
		...
		public ?R2ListObjectsHttpMetadata $httpMetadata = null,
		/** The object key (name). */
		...
		public ?\FoundryCo\Cloudflare\Enums\R2ListObjectsStorageClass $storageClass = null,
	) {
	}
}
