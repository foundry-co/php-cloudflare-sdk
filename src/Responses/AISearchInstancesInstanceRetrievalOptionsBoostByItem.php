...
readonly class AISearchInstancesInstanceRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AISearchInstancesInstanceRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
