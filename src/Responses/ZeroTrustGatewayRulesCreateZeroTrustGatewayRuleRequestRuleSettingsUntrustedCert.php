 ...
 */
readonly class ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsUntrustedCert
{
	public function __construct(
		/** Defines the action performed when an untrusted certificate seen. The default action an error with HTTP code 526. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequestRuleSettingsUntrustedCertAction $action = null,
	) {
	}
}
