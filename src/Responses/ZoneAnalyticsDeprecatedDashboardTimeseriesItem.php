...
readonly class ZoneAnalyticsDeprecatedDashboardTimeseriesItem
{
	public function __construct(
		/** Breakdown of totals for bandwidth in the form of bytes. */
		public ?ZoneAnalyticsDeprecatedDashboardTimeseriesItemBandwidth $bandwidth = null,
		/** Breakdown of totals for pageviews. */
		public ?ZoneAnalyticsDeprecatedDashboardTimeseriesItemPageviews $pageviews = null,
		/** Breakdown of totals for requests. */
		public ?ZoneAnalyticsDeprecatedDashboardTimeseriesItemRequests $requests = null,
		/**
		...
		public ?ZoneAnalyticsDeprecatedDashboardTimeseriesItemThreats $threats = null,
		public ?ZoneAnalyticsDeprecatedDashboardTimeseriesItemUniques $uniques = null,
