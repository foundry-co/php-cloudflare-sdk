...
readonly class GetWorker
{
	public function __construct(
		...
		public ?GetWorkerObservability $observability = null,
		/** Other resources that reference the Worker and depend on it existing. */
		public ?GetWorkerReferences $references = null,
		/** Subdomain settings for the Worker. */
		public ?GetWorkerSubdomain $subdomain = null,
