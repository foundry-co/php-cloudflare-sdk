...
readonly class NamespaceWorkerPutScriptContent
{
	public function __construct(
		...
		public ?NamespaceWorkerPutScriptContentObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?NamespaceWorkerPutScriptContentPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\NamespaceWorkerPutScriptContentUsageModel $usageModel = null,
	) {
	}
}
