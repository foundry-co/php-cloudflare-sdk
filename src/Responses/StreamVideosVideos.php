...
readonly class StreamVideosVideos
{
	public function __construct(
		...
		public ?StreamVideosVideosInput $input = null,
		...
		public ?StreamVideosVideosPlayback $playback = null,
		/** The video's preview page URI. This field is omitted until encoding is complete. */
		public ?string $preview = null,
		/** Public details for the video including title, share link, channel link, and logo. */
		public ?StreamVideosVideosPublicDetails $publicDetails = null,
		...
		public ?StreamVideosVideosStatus $status = null,
		...
		public ?StreamVideosVideosWatermark $watermark = null,
	) {
	}
}
