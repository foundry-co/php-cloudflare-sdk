 ...
 */
readonly class ModifyApplicationRequestConfiguration
{
	public function __construct(
		...
		public ?ModifyApplicationRequestConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?ModifyApplicationRequestConfigurationDns $dns = null,
		/**
		...
		public ?ModifyApplicationRequestConfigurationLifecycle $lifecycle = null,
		...
		public ?ModifyApplicationRequestConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?ModifyApplicationRequestConfigurationObservability $observability = null,
		...
		public ?ModifyApplicationRequestConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
