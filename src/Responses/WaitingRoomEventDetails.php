...
readonly class WaitingRoomEventDetails
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WaitingRoomEventDetailsTurnstileAction $turnstileAction = null,
		/** If set, the event will override the waiting room's `turnstile_mode` property while it is active. If null, the event will inherit it. */
		public ?\FoundryCo\Cloudflare\Enums\WaitingRoomEventDetailsTurnstileMode $turnstileMode = null,
	) {
	}
}
