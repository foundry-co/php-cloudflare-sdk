...
readonly class EditWorker
{
	public function __construct(
		...
		public ?EditWorkerObservability $observability = null,
		/** Other resources that reference the Worker and depend on it existing. */
		public ?EditWorkerReferences $references = null,
		/** Subdomain settings for the Worker. */
		public ?EditWorkerSubdomain $subdomain = null,
