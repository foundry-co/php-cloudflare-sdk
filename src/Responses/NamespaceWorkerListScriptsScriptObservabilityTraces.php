 ...
 */
readonly class NamespaceWorkerListScriptsScriptObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\NamespaceWorkerListScriptsScriptObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
