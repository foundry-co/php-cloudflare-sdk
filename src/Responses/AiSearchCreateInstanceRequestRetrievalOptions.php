...
readonly class AiSearchCreateInstanceRequestRetrievalOptions
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchCreateInstanceRequestRetrievalOptionsKeywordMatchMode $keywordMatchMode = null,
	) {
	}
}
