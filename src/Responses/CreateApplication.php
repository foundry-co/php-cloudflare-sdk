...
readonly class CreateApplication
{
	public function __construct(
		...
		public ?CreateApplicationConfiguration $configuration = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\CreateApplicationSchedulingPolicy $schedulingPolicy = null,
		/** UTC timestamp string in ISO 8601 format */
		public ?string $updatedAt = null,
		public ?int $version = null,
		/** An identifier for a specific rollout within an application. */
		public ?string $activeRolloutId = null,
		public ?CreateApplicationConstraints $constraints = null,
		/** Durable object configuration using a namespace ID */
		public ?CreateApplicationDurableObjects $durableObjects = null,
		public ?CreateApplicationHealth $health = null,
		...
		public ?CreateApplicationObservability $observability = null,
		/**
