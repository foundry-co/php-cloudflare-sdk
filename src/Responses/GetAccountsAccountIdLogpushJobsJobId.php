...
readonly class GetAccountsAccountIdLogpushJobsJobId
{
	public function __construct(
		/** Name of the dataset. A list of supported datasets can be found on the [Developer Docs](https://developers.cloudflare.com/logs/reference/log-fields/). */
		public ?\FoundryCo\Cloudflare\Enums\GetAccountsAccountIdLogpushJobsJobIdDataset $dataset = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\GetAccountsAccountIdLogpushJobsJobIdFrequency $frequency = null,
		/** Unique id of the job. */
		public ?int $id = null,
		/** The kind parameter (optional) is used to differentiate between Logpush and Edge Log Delivery jobs (when supported by the dataset). */
		public ?\FoundryCo\Cloudflare\Enums\GetAccountsAccountIdLogpushJobsJobIdKind $kind = null,
		...
		public ?GetAccountsAccountIdLogpushJobsJobIdOutputOptions $outputOptions = null,
	) {
	}
}
