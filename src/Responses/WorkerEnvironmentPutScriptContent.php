...
readonly class WorkerEnvironmentPutScriptContent
{
	public function __construct(
		...
		public ?WorkerEnvironmentPutScriptContentObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkerEnvironmentPutScriptContentPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerEnvironmentPutScriptContentUsageModel $usageModel = null,
	) {
	}
}
