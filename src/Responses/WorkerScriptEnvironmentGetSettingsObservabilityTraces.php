 ...
 */
readonly class WorkerScriptEnvironmentGetSettingsObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptEnvironmentGetSettingsObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
