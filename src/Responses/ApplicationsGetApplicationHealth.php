...
readonly class ApplicationsGetApplicationHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ApplicationsGetApplicationHealthInstances $instances,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ApplicationsGetApplicationHealthSummary $summary = null,
	) {
	}
}
