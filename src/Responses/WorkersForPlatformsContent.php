...
readonly class WorkersForPlatformsContent
{
	public function __construct(
		...
		public ?WorkersForPlatformsContentObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkersForPlatformsContentPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkersForPlatformsContentUsageModel $usageModel = null,
	) {
	}
}
