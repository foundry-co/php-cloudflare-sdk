 ...
 */
readonly class CustomIndicatorFeedsGetIndicatorFeedMetadataLastUploadSummary
{
	public function __construct(
		 ...
		 */
		public ?CustomIndicatorFeedsGetIndicatorFeedMetadataLastUploadSummaryPersisted $persisted = null,
		/**
		 * Counts of indicators that were uploaded but did not reach
		 * QuickSilver, broken down by reason.
		 */
		public ?CustomIndicatorFeedsGetIndicatorFeedMetadataLastUploadSummarySkipped $skipped = null,
		/** Indicator counts from the unified file the loader received */
		public ?CustomIndicatorFeedsGetIndicatorFeedMetadataLastUploadSummaryUploaded $uploaded = null,
	) {
	}
}
