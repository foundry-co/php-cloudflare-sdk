...
readonly class ZeroTrustCertificatesZeroTrustCertificateDetails
{
	public function __construct(
		/** Indicate the read-only deployment status of the certificate on Cloudflare's edge. Gateway TLS interception can use certificates in the 'available' (previously called 'active') state. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustCertificatesZeroTrustCertificateDetailsBindingStatus $bindingStatus = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustCertificatesZeroTrustCertificateDetailsType $type = null,
