 ...
 */
readonly class LoadBalancersPatchLoadBalancerRulesItemOverrides
{
	public function __construct(
		/** Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin. */
		public ?LoadBalancersPatchLoadBalancerRulesItemOverridesAdaptiveRouting $adaptiveRouting = null,
		...
		public ?LoadBalancersPatchLoadBalancerRulesItemOverridesLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?LoadBalancersPatchLoadBalancerRulesItemOverridesRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRulesItemOverridesSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?LoadBalancersPatchLoadBalancerRulesItemOverridesSessionAffinityAttributes $sessionAffinityAttributes = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersPatchLoadBalancerRulesItemOverridesSteeringPolicy $steeringPolicy = null,
