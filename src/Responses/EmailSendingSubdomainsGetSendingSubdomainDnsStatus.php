...
readonly class EmailSendingSubdomainsGetSendingSubdomainDnsStatus
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\EmailSendingSubdomainsGetSendingSubdomainDnsStatusStatus $status = null,
	) {
	}
}
