 ...
 */
readonly class GetTableMaintenanceConfigMaintenanceConfigSnapshotExpiration
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\GetTableMaintenanceConfigMaintenanceConfigSnapshotExpirationState $state = null,
	) {
	}
}
