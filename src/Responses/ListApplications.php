 ...
 */
readonly class ListApplications
{
	public function __construct(
		...
		public ?ListApplicationsConfiguration $configuration = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\ListApplicationsSchedulingPolicy $schedulingPolicy = null,
		/** UTC timestamp string in ISO 8601 format */
		public ?string $updatedAt = null,
		public ?int $version = null,
		/** An identifier for a specific rollout within an application. */
		public ?string $activeRolloutId = null,
		public ?ListApplicationsConstraints $constraints = null,
		/** Durable object configuration using a namespace ID */
		public ?ListApplicationsDurableObjects $durableObjects = null,
		public ?ListApplicationsHealth $health = null,
		...
		public ?ListApplicationsObservability $observability = null,
		/**
