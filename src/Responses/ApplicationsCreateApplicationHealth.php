...
readonly class ApplicationsCreateApplicationHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ApplicationsCreateApplicationHealthInstances $instances,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ApplicationsCreateApplicationHealthSummary $summary = null,
	) {
	}
}
