...
readonly class ZeroTrustGatewayRulesCreateZeroTrustGatewayRule
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleAction $action = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleExpiration $expiration = null,
		...
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleSchedule $schedule = null,
