 ...
 */
readonly class TokenValidationRulesList
{
	public function __construct(
		/** Action to take on requests that match operations included in `selector` and fail `expression`. */
		public ?\FoundryCo\Cloudflare\Enums\TokenValidationRulesListAction $action = null,
		 ...
		 */
		public ?TokenValidationRulesListSelector $selector = null,
