...
readonly class AccountApiTokensListTokens
{
	public function __construct(
		public ?AccountApiTokensListTokensCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\AccountApiTokensListTokensStatus $status = null,
	) {
	}
}
