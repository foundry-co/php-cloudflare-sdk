...
readonly class AccountOwnedAPITokensToken
{
	public function __construct(
		public ?AccountOwnedAPITokensTokenCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\AccountOwnedAPITokensTokenStatus $status = null,
		/** The token value. */
