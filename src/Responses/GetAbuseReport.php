...
readonly class GetAbuseReport
{
	public function __construct(
		...
		public ?GetAbuseReportMitigationSummary $mitigationSummary = null,
		/** An enum value that represents the status of an abuse record */
		public ?\FoundryCo\Cloudflare\Enums\GetAbuseReportStatus $status = null,
		/** The abuse report type */
		public ?\FoundryCo\Cloudflare\Enums\GetAbuseReportType $type = null,
		/** Justification for the report. */
		public ?string $justification = null,
		/** Original work / Targeted brand in the alleged abuse. */
		public ?string $originalWork = null,
		/** Information about the submitter of the report. */
		public ?GetAbuseReportSubmitter $submitter = null,
