 ...
 */
readonly class ZeroTrustGatewayRulesDetailsRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesDetailsRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
