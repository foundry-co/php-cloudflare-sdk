...
readonly class ListApplicationsHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ?ListApplicationsHealthInstances $instances = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ListApplicationsHealthSummary $summary = null,
	) {
	}
}
