...
readonly class AccountOwnedAPITokensDetails
{
	public function __construct(
		public ?AccountOwnedAPITokensDetailsCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\AccountOwnedAPITokensDetailsStatus $status = null,
	) {
	}
}
