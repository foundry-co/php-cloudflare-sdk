 ...
 */
readonly class WorkerScriptSettingsPatchSettingsObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptSettingsPatchSettingsObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
