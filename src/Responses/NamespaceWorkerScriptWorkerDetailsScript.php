...
readonly class NamespaceWorkerScriptWorkerDetailsScript
{
	public function __construct(
		...
		public ?NamespaceWorkerScriptWorkerDetailsScriptObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?NamespaceWorkerScriptWorkerDetailsScriptPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\NamespaceWorkerScriptWorkerDetailsScriptUsageModel $usageModel = null,
	) {
	}
}
