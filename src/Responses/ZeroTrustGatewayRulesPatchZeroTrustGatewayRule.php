...
readonly class ZeroTrustGatewayRulesPatchZeroTrustGatewayRule
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleAction $action = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleExpiration $expiration = null,
		...
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?ZeroTrustGatewayRulesPatchZeroTrustGatewayRuleSchedule $schedule = null,
