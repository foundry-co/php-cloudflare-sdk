...
readonly class MagicGRETunnelsTunnelModifiedGreTunnelBgpStatus
{
	public function __construct(
		public \FoundryCo\Cloudflare\Enums\MagicGRETunnelsTunnelModifiedGreTunnelBgpStatusState $state,
