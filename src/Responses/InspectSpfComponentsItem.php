 ...
 */
readonly class InspectSpfComponentsItem
{
	public function __construct(
		 ...
		 * - IP4, IP6, ALL: 0
		 */
		public ?int $lookupCount = null,
		/** SPF mechanism result qualifier */
		public ?\FoundryCo\Cloudflare\Enums\InspectSpfComponentsItemResult $result = null,
		/** Component type (UPPERCASE) */
		public ?\FoundryCo\Cloudflare\Enums\InspectSpfComponentsItemType $type = null,
		/**
