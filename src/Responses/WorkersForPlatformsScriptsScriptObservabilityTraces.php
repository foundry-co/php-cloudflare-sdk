 ...
 */
readonly class WorkersForPlatformsScriptsScriptObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkersForPlatformsScriptsScriptObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
