...
readonly class OriginCACertificate
{
	public function __construct(
		...
		public \FoundryCo\Cloudflare\Enums\OriginCACertificateRequestType $requestType,
		/** The number of days for which the certificate should be valid. */
		public \FoundryCo\Cloudflare\Enums\OriginCACertificateRequestedValidity $requestedValidity,
