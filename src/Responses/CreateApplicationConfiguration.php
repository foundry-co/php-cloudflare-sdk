 ...
 */
readonly class CreateApplicationConfiguration
{
	public function __construct(
		...
		public ?CreateApplicationConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?CreateApplicationConfigurationDns $dns = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\CreateApplicationConfigurationInstanceType $instanceType = null,
		/** Deployment labels */
		public ?array $labels = null,
		/** Lifecycle configuration for a deployment. */
		public ?CreateApplicationConfigurationLifecycle $lifecycle = null,
		...
		public ?CreateApplicationConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?CreateApplicationConfigurationObservability $observability = null,
		...
		public ?CreateApplicationConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
