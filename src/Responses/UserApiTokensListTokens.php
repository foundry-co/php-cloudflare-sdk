...
readonly class UserApiTokensListTokens
{
	public function __construct(
		public ?UserApiTokensListTokensCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\UserApiTokensListTokensStatus $status = null,
	) {
	}
}
