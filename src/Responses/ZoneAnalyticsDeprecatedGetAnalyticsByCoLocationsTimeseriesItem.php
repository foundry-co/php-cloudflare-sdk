...
readonly class ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTimeseriesItem
{
	public function __construct(
		/** Breakdown of totals for bandwidth in the form of bytes. */
		public ?ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTimeseriesItemBandwidth $bandwidth = null,
		/** Breakdown of totals for requests. */
		public ?ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTimeseriesItemRequests $requests = null,
		/**
		...
		public ?ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsTimeseriesItemThreats $threats = null,
