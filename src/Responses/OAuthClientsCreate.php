...
readonly class OauthClientsCreate
{
	public function __construct(
		public mixed $clientId = null,
		/** Visibility of the OAuth client. */
		public ?\FoundryCo\Cloudflare\Enums\OauthClientsCreateVisibility $visibility = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\OauthClientsCreateTokenEndpointAuthMethod $tokenEndpointAuthMethod = null,
		/** URL that points to a terms of service document. */
		public ?string $tosUri = null,
		/** Client URI domain control verification state. */
		public ?OauthClientsCreateClientUriVerification $clientUriVerification = null,
