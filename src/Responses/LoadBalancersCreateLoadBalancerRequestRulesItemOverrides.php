 ...
 */
readonly class LoadBalancersCreateLoadBalancerRequestRulesItemOverrides
{
	public function __construct(
		/** Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin. */
		public ?LoadBalancersCreateLoadBalancerRequestRulesItemOverridesAdaptiveRouting $adaptiveRouting = null,
		...
		public ?LoadBalancersCreateLoadBalancerRequestRulesItemOverridesLocationStrategy $locationStrategy = null,
		 ...
		 */
		public ?LoadBalancersCreateLoadBalancerRequestRulesItemOverridesRandomSteering $randomSteering = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersCreateLoadBalancerRequestRulesItemOverridesSessionAffinity $sessionAffinity = null,
		/** Configures attributes for session affinity. */
		public ?LoadBalancersCreateLoadBalancerRequestRulesItemOverridesSessionAffinityAttributes $sessionAffinityAttributes = null,
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\LoadBalancersCreateLoadBalancerRequestRulesItemOverridesSteeringPolicy $steeringPolicy = null,
