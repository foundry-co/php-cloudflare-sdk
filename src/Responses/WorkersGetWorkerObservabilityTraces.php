 ...
 */
readonly class WorkersGetWorkerObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkersGetWorkerObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
