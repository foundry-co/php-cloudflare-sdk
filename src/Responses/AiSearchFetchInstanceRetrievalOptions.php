...
readonly class AiSearchFetchInstanceRetrievalOptions
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchFetchInstanceRetrievalOptionsKeywordMatchMode $keywordMatchMode = null,
	) {
	}
}
