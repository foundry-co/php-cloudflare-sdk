...
readonly class AiSearchDeleteInstanceRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchDeleteInstanceRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
