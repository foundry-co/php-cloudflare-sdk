 ...
 */
readonly class TokenValidationRulesCreate
{
	public function __construct(
		/** Action to take on requests that match operations included in `selector` and fail `expression`. */
		public ?\FoundryCo\Cloudflare\Enums\TokenValidationRulesCreateAction $action = null,
		 ...
		 */
		public ?TokenValidationRulesCreateSelector $selector = null,
