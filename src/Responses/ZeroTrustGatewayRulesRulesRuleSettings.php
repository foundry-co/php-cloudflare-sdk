 ...
 */
readonly class ZeroTrustGatewayRulesRulesRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesRulesRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesRulesRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesRulesRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesRulesRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
