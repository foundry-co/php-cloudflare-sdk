...
readonly class OriginCACertificates
{
	public function __construct(
		...
		public \FoundryCo\Cloudflare\Enums\OriginCACertificatesRequestType $requestType,
		/** The number of days for which the certificate should be valid. */
		public \FoundryCo\Cloudflare\Enums\OriginCACertificatesRequestedValidity $requestedValidity,
