...
readonly class CreateApplicationRolloutHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ?CreateApplicationRolloutHealthInstances $instances = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\CreateApplicationRolloutHealthSummary $summary = null,
	) {
	}
}
