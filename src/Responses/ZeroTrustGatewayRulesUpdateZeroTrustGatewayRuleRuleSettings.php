 ...
 */
readonly class ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
