...
readonly class ApplicationsModifyApplicationHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ApplicationsModifyApplicationHealthInstances $instances,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ApplicationsModifyApplicationHealthSummary $summary = null,
	) {
	}
}
