...
readonly class ListWorkers
{
	public function __construct(
		...
		public ?ListWorkersObservability $observability = null,
		/** Other resources that reference the Worker and depend on it existing. */
		public ?ListWorkersReferences $references = null,
		/** Subdomain settings for the Worker. */
		public ?ListWorkersSubdomain $subdomain = null,
