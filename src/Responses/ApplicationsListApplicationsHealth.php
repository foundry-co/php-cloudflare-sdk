...
readonly class ApplicationsListApplicationsHealth
{
	public function __construct(
		/** Shows a count of application instance states. */
		public ApplicationsListApplicationsHealthInstances $instances,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\ApplicationsListApplicationsHealthSummary $summary = null,
	) {
	}
}
