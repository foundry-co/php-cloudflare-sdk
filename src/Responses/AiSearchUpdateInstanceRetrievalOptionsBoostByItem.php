...
readonly class AiSearchUpdateInstanceRetrievalOptionsBoostByItem
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchUpdateInstanceRetrievalOptionsBoostByItemDirection $direction = null,
	) {
	}
}
