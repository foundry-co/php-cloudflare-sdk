 ...
 */
readonly class ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesZeroTrustGatewayRuleDetailsRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
