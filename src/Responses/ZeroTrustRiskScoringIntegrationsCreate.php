...
readonly class ZeroTrustRiskScoringIntegrationsCreate
{
	public function __construct(
		...
		public string $id,
		public \FoundryCo\Cloudflare\Enums\ZeroTrustRiskScoringIntegrationsCreateIntegrationType $integrationType,
		/**
