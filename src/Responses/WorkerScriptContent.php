...
readonly class WorkerScriptContent
{
	public function __construct(
		...
		public ?WorkerScriptContentObservability $observability = null,
		/** Configuration for [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement). Specify mode='smart' for Smart Placement, or one of region/hostname/host. */
		public ?WorkerScriptContentPlacement $placement = null,
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkerScriptContentUsageModel $usageModel = null,
	) {
	}
}
