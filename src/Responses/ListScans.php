...
readonly class ListScans
{
	public function __construct(
		/** Scan identifier. */
		public ?string $id = null,
		/** The type of vulnerability scan. */
		public ?\FoundryCo\Cloudflare\Enums\ListScansScanType $scanType = null,
		/** Current lifecycle status of the scan. */
		public ?\FoundryCo\Cloudflare\Enums\ListScansStatus $status = null,
		...
		public ?ListScansReport $report = null,
	) {
	}
}
