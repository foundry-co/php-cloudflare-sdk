...
readonly class AiSearchCreateInstanceRetrievalOptions
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\AiSearchCreateInstanceRetrievalOptionsKeywordMatchMode $keywordMatchMode = null,
	) {
	}
}
