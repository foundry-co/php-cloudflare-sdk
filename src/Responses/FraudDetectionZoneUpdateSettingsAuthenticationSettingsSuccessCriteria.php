...
readonly class FraudDetectionZoneUpdateSettingsAuthenticationSettingsSuccessCriteria
{
	public function __construct(
		/** The type of criterion. Currently only `status_code` is supported. */
		public ?\FoundryCo\Cloudflare\Enums\FraudDetectionZoneUpdateSettingsAuthenticationSettingsSuccessCriteriaKind $kind = null,
		/**
