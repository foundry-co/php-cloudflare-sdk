 ...
 */
readonly class ApplicationsCreateApplication
{
	public function __construct(
		...
		public ApplicationsCreateApplicationConfiguration $configuration,
		...
		public \FoundryCo\Cloudflare\Enums\ApplicationsCreateApplicationSchedulingPolicy $schedulingPolicy,
		/** UTC timestamp string in ISO 8601 format */
		public string $updatedAt,
		public int $version,
		/** An identifier for a specific rollout within an application. */
		public ?string $activeRolloutId = null,
		public ?ApplicationsCreateApplicationConstraints $constraints = null,
		/** Durable object configuration using a namespace ID */
		public ?ApplicationsCreateApplicationDurableObjects $durableObjects = null,
		public ?ApplicationsCreateApplicationHealth $health = null,
		...
		public ?ApplicationsCreateApplicationObservability $observability = null,
		/**
