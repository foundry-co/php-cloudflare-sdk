 ...
 */
readonly class WorkersForPlatformsDetailsScriptObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkersForPlatformsDetailsScriptObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
