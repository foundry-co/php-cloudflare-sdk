 ...
 */
readonly class ZeroTrustGatewayRulesTenantRuleSettingsUntrustedCert
{
	public function __construct(
		/** Defines the action performed when an untrusted certificate seen. The default action an error with HTTP code 526. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesTenantRuleSettingsUntrustedCertAction $action = null,
	) {
	}
}
