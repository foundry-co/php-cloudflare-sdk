...
readonly class ZeroTrustRiskScoringIntegrationsGet
{
	public function __construct(
		...
		public string $id,
		public \FoundryCo\Cloudflare\Enums\ZeroTrustRiskScoringIntegrationsGetIntegrationType $integrationType,
		/**
