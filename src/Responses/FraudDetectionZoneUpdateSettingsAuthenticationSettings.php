 ...
 */
readonly class FraudDetectionZoneUpdateSettingsAuthenticationSettings
{
	public function __construct(
		/** Criterion for identifying failed login responses. */
		public ?FraudDetectionZoneUpdateSettingsAuthenticationSettingsFailureCriteria $failureCriteria = null,
		/** Criterion for identifying successful login responses. */
		public ?FraudDetectionZoneUpdateSettingsAuthenticationSettingsSuccessCriteria $successCriteria = null,
	) {
	}
}
