 ...
 */
readonly class CreateApplicationRolloutCurrentConfiguration
{
	public function __construct(
		...
		public ?CreateApplicationRolloutCurrentConfigurationDisk $disk = null,
		/**
		 ...
		 */
		public ?CreateApplicationRolloutCurrentConfigurationDns $dns = null,
		/**
		 ...
		 */
		public ?\FoundryCo\Cloudflare\Enums\CreateApplicationRolloutCurrentConfigurationInstanceType $instanceType = null,
		/** Deployment labels */
		public ?array $labels = null,
		/** Lifecycle configuration for a deployment. */
		public ?CreateApplicationRolloutCurrentConfigurationLifecycle $lifecycle = null,
		...
		public ?CreateApplicationRolloutCurrentConfigurationMetadataService $metadataService = null,
		/** Settings for deployment observability such as logging. */
		public ?CreateApplicationRolloutCurrentConfigurationObservability $observability = null,
		...
		public ?CreateApplicationRolloutCurrentConfigurationWranglerSsh $wranglerSsh = null,
	) {
	}
}
