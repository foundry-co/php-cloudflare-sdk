 ...
 */
readonly class TokenValidationRulesBulkEdit
{
	public function __construct(
		/** Action to take on requests that match operations included in `selector` and fail `expression`. */
		public ?\FoundryCo\Cloudflare\Enums\TokenValidationRulesBulkEditAction $action = null,
		 ...
		 */
		public ?TokenValidationRulesBulkEditSelector $selector = null,
