...
readonly class AccountApiTokensTokenDetails
{
	public function __construct(
		public ?AccountApiTokensTokenDetailsCondition $condition = null,
		...
		/** Status of the token. */
		public ?\FoundryCo\Cloudflare\Enums\AccountApiTokensTokenDetailsStatus $status = null,
	) {
	}
}
