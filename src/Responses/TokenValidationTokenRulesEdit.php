 ...
 */
readonly class TokenValidationTokenRulesEdit
{
	public function __construct(
		/** Action to take on requests that match operations included in `selector` and fail `expression`. */
		public \FoundryCo\Cloudflare\Enums\TokenValidationTokenRulesEditAction $action,
		 ...
		 */
		public TokenValidationTokenRulesEditSelector $selector,
