...
readonly class ZeroTrustGatewayRulesRules
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public \FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesRulesAction $action,
		...
		public ?ZeroTrustGatewayRulesRulesExpiration $expiration = null,
		...
		public ?ZeroTrustGatewayRulesRulesRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?ZeroTrustGatewayRulesRulesSchedule $schedule = null,
