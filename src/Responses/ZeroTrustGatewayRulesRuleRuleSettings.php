 ...
 */
readonly class ZeroTrustGatewayRulesRuleRuleSettings
{
	public function __construct(
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsAuditSsh $auditSsh = null,
		/** Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`. */
		public ?ZeroTrustGatewayRulesRuleRuleSettingsBisoAdminControls $bisoAdminControls = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsBlockPage $blockPage = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsCheckSession $checkSession = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsDnsResolvers $dnsResolvers = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsEgress $egress = null,
		/** Configure whether a copy of the HTTP request will be sent to storage when the rule matches. */
		public ?ZeroTrustGatewayRulesRuleRuleSettingsForensicCopy $forensicCopy = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsL4override $l4override = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsNotificationSettings $notificationSettings = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsPayloadLog $payloadLog = null,
		/** Configure settings that apply to quarantine rules. Settable only for `http` rules. */
		public ?ZeroTrustGatewayRulesRuleRuleSettingsQuarantine $quarantine = null,
		/** Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`. */
		public ?ZeroTrustGatewayRulesRuleRuleSettingsRedirect $redirect = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsResolveDnsInternally $resolveDnsInternally = null,
		...
		public ?ZeroTrustGatewayRulesRuleRuleSettingsUntrustedCert $untrustedCert = null,
	) {
	}
}
