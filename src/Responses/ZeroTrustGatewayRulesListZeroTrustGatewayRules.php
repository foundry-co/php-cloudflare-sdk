...
readonly class ZeroTrustGatewayRulesListZeroTrustGatewayRules
{
	public function __construct(
		/** Specify the action to perform when the associated traffic, identity, and device posture expressions either absent or evaluate to `true`. */
		public ?\FoundryCo\Cloudflare\Enums\ZeroTrustGatewayRulesListZeroTrustGatewayRulesAction $action = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesExpiration $expiration = null,
		...
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesRuleSettings $ruleSettings = null,
		/** Defines the schedule for activating DNS policies. Settable only for `dns` and `dns_resolver` rules. */
		public ?ZeroTrustGatewayRulesListZeroTrustGatewayRulesSchedule $schedule = null,
