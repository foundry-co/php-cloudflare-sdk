 ...
 */
readonly class WorkersForPlatformsContentObservabilityTraces
{
	public function __construct(
		...
		public ?\FoundryCo\Cloudflare\Enums\WorkersForPlatformsContentObservabilityTracesPropagationPolicy $propagationPolicy = null,
	) {
	}
}
